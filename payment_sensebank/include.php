...
define('PAYMENT_SENSEBANK_ENABLE_REFUNDS', true);

define('PAYMENT_SENSEBANK_MEASUREMENT_NAME', 'шт');
define('PAYMENT_SENSEBANK_MEASUREMENT_CODE', 0);

define('PAYMENT_SENSEBANK_ENABLE_CALLBACK', true);
